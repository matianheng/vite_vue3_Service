...
export default {
    ...
    GET_BBS_AGENT_USER_LIST: {
      ...
      //------------------------------------小程序管理----------------------------------------------------------//
        //获取模板列表
        GET_TEMPLATE_PAGE: {
        path: '/serviceEmp/web-api-public-minimgr-getTemplatePage',
        resourceId: 'GET_TEMPLATE_PAGE',
        method: httpRequestConstants.METHOD_POST,
    },
        //获取模板详情
        GET_TEMPLATE_DETAIL: {
            path: '/serviceEmp/web-api-public-minimgr-getTemplateDetail',
            resourceId: 'GET_TEMPLATE_DETAIL',
            method: httpRequestConstants.METHOD_POST,
        },
        //新增模板
        ADD_TEMPLATE: {
        path: '/serviceEmp/web-api-public-minimgr-addTemplate',
        resourceId: 'ADD_TEMPLATE',
        method: httpRequestConstants.METHOD_POST,
    },
        //更新小程序模板状态
        UPDATE_TEMPLATE_STATUS: {
            path: '/serviceEmp/web-api-public-minimgr-updateTemplateStatus',
            resourceId: 'UPDATE_TEMPLATE_STATUS',
            method: httpRequestConstants.METHOD_POST,
        },
        //获取小程序链接分页列表
        GET_LINK_PAGE: {
            path: '/serviceEmp/web-api-public-minimgr-getLinkPage',
            resourceId: 'GET_LINK_PAGE',
            method: httpRequestConstants.METHOD_POST,
        },
        // 获取小程序链接详情
        GET_LINK_DETAIL: {
            path: '/serviceEmp/web-api-public-minimgr-getLinkDetail',
            resourceId: 'GET_LINK_DETAIL',
            method: httpRequestConstants.METHOD_POST,
        },
        // 新增链接
        ADD_LINK: {
            path: '/serviceEmp/web-api-public-minimgr-addLink',
            resourceId: 'ADD_LINK',
            method: httpRequestConstants.METHOD_POST,
        },
        //  更新链接抖音二维码挂载地址
        UPDATE_LINK: {
            path: '/serviceEmp/web-api-public-minimgr-updateLink',
            resourceId: 'UPDATE_LINK',
            method: httpRequestConstants.METHOD_POST,
        },
           // 生成短连接
           ADD_SHORT_LINK: {
            path: '/serviceEmp/web-api-public-minimgr-addShortLink',
            resourceId: 'ADD_SHORT_LINK',
            method: httpRequestConstants.METHOD_POST,
        },
            // 获取断链列表
            GET_SHORT_LINKS: {
            path: '/serviceEmp/web-api-public-minimgr-getShortLinks',
            resourceId: 'GET_SHORT_LINKS',
            method: httpRequestConstants.METHOD_POST,
        },
        //二维码
        CREATE_QR_LINK: {
                path: '/serviceEmp/web-api-public-minimgr-createQrLink',
                resourceId: 'CREATE_QR_LINK',
                method: httpRequestConstants.METHOD_POST,
            },
      ...
      //------------------------------------雪佛兰版本管理----------------------------------------------------------//
        ...
        //获取版本
        APPVERSION_GET: {
            path: '/web/appversion/get',
            resourceId: 'APPVERSION_GET',
            method: httpRequestConstants.METHOD_POST,
        },
        //修改版本
        APPVERSION_UPDATE: {
            path: '/web/appversion/update',
            resourceId: 'APPVERSION_UPDATE',
            method: httpRequestConstants.METHOD_POST,
        },
       //新增版本
       APPVERSION_ADD: {
            path: '/web/appversion/add',
            resourceId: 'APPVERSION_ADD',
            method: httpRequestConstants.METHOD_POST,
        },
