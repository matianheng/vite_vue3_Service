...
export    default {
    ...
    //------------------------------------小程序管理----------------------------------------------------------//
    getTemplatePage(data) {//获取模板列表
        return baseService(AppUrls.GET_TEMPLATE_PAGE, {
            data: data
        })
    },
    getTemplateDetail(data) {//获取模板详情
        return baseService(AppUrls.GET_TEMPLATE_DETAIL, {
            data: data
        })
    },
    addTemplate(data) {//新增模板
        return baseService(AppUrls.ADD_TEMPLATE, {
            data: data
        })
    },
    updateTemplateStatus(data) {//新增模板
        return baseService(AppUrls.UPDATE_TEMPLATE_STATUS, {
            data: data
        })
    },
    getLinkPage(data) {//获取小程序链接分页列表
        return baseService(AppUrls.GET_LINK_PAGE, {
            data: data
        })
    },
    getLinkDetail(data) {//获取小程序链接详情
        return baseService(AppUrls.GET_LINK_DETAIL, {
            data: data
        })
    },
    addLink(data) {//新增链接
        return baseService(AppUrls.ADD_LINK, {
            data: data
        })
    },
    updateLink(data) {//更新链接抖音二维码挂载地址
        return baseService(AppUrls.UPDATE_LINK, {
            data: data
        })
    },
    addShortLink(data) {//生成短连接
        return baseService(AppUrls.ADD_SHORT_LINK, {
            data: data
        })
    },
    getShortLinks(data) {//生成短连接
        return baseService(AppUrls.GET_SHORT_LINKS, {
            data: data
        })
    },
    createQrLink(data) {//生成短连接
        return baseService(AppUrls.CREATE_QR_LINK, {
            data: data
        })
    },
 //------------------------------------雪佛兰版本管理----------------------------------------------------------//
    appversionGet(data) {//获取版本
        return baseService(AppUrls.APPVERSION_GET, {
            data: data
        })
    },
    appversionUpdate(data) {//修改版本
        return baseService(AppUrls.APPVERSION_UPDATE, {
            data: data
        })
    },
    appversionAdd(data) {//新增版本
        return baseService(AppUrls.APPVERSION_ADD, {
            data: data
        })
    },
